...
MACRO(SWIG_ADD_SOURCE_TO_MODULE name outfiles infile)
  ...
  GET_SOURCE_FILE_PROPERTY(swig_source_file_POST_GENERATE_COMMAND ${infile} POST_GENERATE_COMMAND)
  GET_SOURCE_FILE_PROPERTY(swig_source_file_POST_GENERATE_ARGS ${infile} POST_GENERATE_ARGS)
  ...
  #use ccache-swig if possible
  FIND_PROGRAM(CCACHE_SWIG_EXECUTABLE ccache-swig)
  IF (CCACHE_SWIG_EXECUTABLE)
    SET(swig_cmd ${CCACHE_SWIG_EXECUTABLE})
    SET(swig_arg ${SWIG_EXECUTABLE})
  ELSE()
    SET(swig_cmd ${SWIG_EXECUTABLE})
    SET(swig_arg)
  ENDIF()
  ...
  ADD_CUSTOM_COMMAND(
    ...
    COMMAND "${swig_cmd}"
    ARGS "${swig_arg}" "-${SWIG_MODULE_${name}_SWIG_LANGUAGE_FLAG}"
    ...
    COMMAND
      ${swig_source_file_POST_GENERATE_COMMAND}
    ARGS
      ${swig_source_file_POST_GENERATE_ARGS}
